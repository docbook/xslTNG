...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
   ...
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario1"
      ...
      <xsl:element name="scenario" namespace="http://www.jenitennison.com/xslt/xspec">
         ...
         <xsl:variable name="Q{http://www.jenitennison.com/xslt/xspec}result" as="item()*">
            <xsl:apply-templates select="$Q{urn:x-xspec:compile:impl}context-d78e0"/>
         </xsl:variable>
   ...
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario1-expect1"
      ...
      <xsl:variable name="Q{urn:x-xspec:compile:impl}expect-d75e5-doc"
                    as="document-node()"
                    select="doc('file:/home/runner/work/xslTNG/xslTNG/src/test/resources/expected/en_note.001.html')"/>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}expect-d75e5"
                    select="$Q{urn:x-xspec:compile:impl}expect-d75e5-doc ! ( . )"><!--expected result--></xsl:variable>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}successful"
                    as="Q{http://www.w3.org/2001/XMLSchema}boolean"
                    select="Q{urn:x-xspec:common:deep-equal}deep-equal($Q{urn:x-xspec:compile:impl}expect-d75e5, $Q{http://www.jenitennison.com/xslt/xspec}result, '')"/>
      ...
      <xsl:element name="test" namespace="http://www.jenitennison.com/xslt/xspec">
         ...
         <xsl:call-template name="Q{urn:x-xspec:common:report-sequence}report-sequence">
            <xsl:with-param name="sequence" select="$Q{urn:x-xspec:compile:impl}expect-d75e5"/>
   ...
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario2"
      ...
      <xsl:element name="scenario" namespace="http://www.jenitennison.com/xslt/xspec">
         ...
         <xsl:variable name="Q{urn:x-xspec:compile:impl}context-d86e0"
   ...
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario2-expect1"
      ...
      <xsl:param name="Q{http://www.jenitennison.com/xslt/xspec}result"
                 ...
                 required="yes"/>
      <xsl:message>expect it to be rendered in English</xsl:message>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}expect-d75e8-doc"
                    as="document-node()"
      ...
      <xsl:variable name="Q{urn:x-xspec:compile:impl}expect-d75e8"
                    select="$Q{urn:x-xspec:compile:impl}expect-d75e8-doc ! ( . )"><!--expected result--></xsl:variable>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}successful"
                    as="Q{http://www.w3.org/2001/XMLSchema}boolean"
   ...
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario3"
      ...
      <xsl:element name="scenario" namespace="http://www.jenitennison.com/xslt/xspec">
         ...
         <xsl:variable name="Q{http://www.jenitennison.com/xslt/xspec}result" as="item()*">
            <xsl:apply-templates select="$Q{urn:x-xspec:compile:impl}context-d94e0"/>
         </xsl:variable>
         <xsl:call-template name="Q{urn:x-xspec:common:report-sequence}report-sequence">
            <xsl:with-param name="sequence"
                            select="$Q{http://www.jenitennison.com/xslt/xspec}result"/>
   ...
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario3-expect1"
      ...
      <xsl:param name="Q{http://www.jenitennison.com/xslt/xspec}result"
                 ...
                 required="yes"/>
      <xsl:message>expect it to be rendered in English</xsl:message>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}expect-d75e11-doc"
                    as="document-node()"
                    select="doc('file:/home/runner/work/xslTNG/xslTNG/src/test/resources/expected/en_note.003.html')"/>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}expect-d75e11"
                    select="$Q{urn:x-xspec:compile:impl}expect-d75e11-doc ! ( . )"><!--expected result--></xsl:variable>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}successful"
                    as="Q{http://www.w3.org/2001/XMLSchema}boolean"
                    select="Q{urn:x-xspec:common:deep-equal}deep-equal($Q{urn:x-xspec:compile:impl}expect-d75e11, $Q{http://www.jenitennison.com/xslt/xspec}result, '')"/>
      <xsl:if test="not($Q{urn:x-xspec:compile:impl}successful)">
         <xsl:message>      FAILED</xsl:message>
      </xsl:if>
      <xsl:element name="test" namespace="http://www.jenitennison.com/xslt/xspec">
         ...
         <xsl:call-template name="Q{urn:x-xspec:common:report-sequence}report-sequence">
            <xsl:with-param name="sequence" select="$Q{urn:x-xspec:compile:impl}expect-d75e11"/>
            <xsl:with-param name="report-name" select="'expect'"/>
         </xsl:call-template>
      </xsl:element>
   </xsl:template>
   ...
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario4-expect1"
      ...
      <xsl:param name="Q{http://www.jenitennison.com/xslt/xspec}result"
                 ...
                 required="yes"/>
      <xsl:message>expect it to be rendered in English</xsl:message>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}expect-d75e14-doc"
                    as="document-node()"
                    select="doc('file:/home/runner/work/xslTNG/xslTNG/src/test/resources/expected/en_tip.001.html')"/>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}expect-d75e14"
                    select="$Q{urn:x-xspec:compile:impl}expect-d75e14-doc ! ( . )"><!--expected result--></xsl:variable>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}successful"
                    as="Q{http://www.w3.org/2001/XMLSchema}boolean"
                    select="Q{urn:x-xspec:common:deep-equal}deep-equal($Q{urn:x-xspec:compile:impl}expect-d75e14, $Q{http://www.jenitennison.com/xslt/xspec}result, '')"/>
      <xsl:if test="not($Q{urn:x-xspec:compile:impl}successful)">
         <xsl:message>      FAILED</xsl:message>
      </xsl:if>
      <xsl:element name="test" namespace="http://www.jenitennison.com/xslt/xspec">
         ...
         <xsl:call-template name="Q{urn:x-xspec:common:report-sequence}report-sequence">
            <xsl:with-param name="sequence" select="$Q{urn:x-xspec:compile:impl}expect-d75e14"/>
            <xsl:with-param name="report-name" select="'expect'"/>
         </xsl:call-template>
      </xsl:element>
   </xsl:template>
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario5"
      ...
      <xsl:element name="scenario" namespace="http://www.jenitennison.com/xslt/xspec">
         ...
         <xsl:variable name="Q{http://www.jenitennison.com/xslt/xspec}result" as="item()*">
            <xsl:apply-templates select="$Q{urn:x-xspec:compile:impl}context-d110e0"/>
         </xsl:variable>
         <xsl:call-template name="Q{urn:x-xspec:common:report-sequence}report-sequence">
            <xsl:with-param name="sequence"
                            select="$Q{http://www.jenitennison.com/xslt/xspec}result"/>
   ...
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario5-expect1"
      ...
      <xsl:variable name="Q{urn:x-xspec:compile:impl}expect-d75e17"
                    select="$Q{urn:x-xspec:compile:impl}expect-d75e17-doc ! ( . )"><!--expected result--></xsl:variable>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}successful"
                    as="Q{http://www.w3.org/2001/XMLSchema}boolean"
   ...
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario6"
      ...
      <xsl:element name="scenario" namespace="http://www.jenitennison.com/xslt/xspec">
         ...
         <xsl:variable name="Q{urn:x-xspec:compile:impl}context-d118e0"
                       select="$Q{urn:x-xspec:compile:impl}context-d118e0-doc ! ( . )"/>
         <xsl:variable name="Q{http://www.jenitennison.com/xslt/xspec}context"
                       as="item()*"
                       select="$Q{urn:x-xspec:compile:impl}context-d118e0"/>
         <xsl:variable name="Q{http://www.jenitennison.com/xslt/xspec}result" as="item()*">
            <xsl:apply-templates select="$Q{urn:x-xspec:compile:impl}context-d118e0"/>
         </xsl:variable>
         <xsl:call-template name="Q{urn:x-xspec:common:report-sequence}report-sequence">
            <xsl:with-param name="sequence"
                            select="$Q{http://www.jenitennison.com/xslt/xspec}result"/>
   ...
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario6-expect1"
      ...
      <xsl:param name="Q{http://www.jenitennison.com/xslt/xspec}result"
                 ...
                 required="yes"/>
      <xsl:message>expect it to be rendered in English</xsl:message>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}expect-d75e20-doc"
                    as="document-node()"
                    select="doc('file:/home/runner/work/xslTNG/xslTNG/src/test/resources/expected/en_important.001.html')"/>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}expect-d75e20"
                    select="$Q{urn:x-xspec:compile:impl}expect-d75e20-doc ! ( . )"><!--expected result--></xsl:variable>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}successful"
                    as="Q{http://www.w3.org/2001/XMLSchema}boolean"
                    select="Q{urn:x-xspec:common:deep-equal}deep-equal($Q{urn:x-xspec:compile:impl}expect-d75e20, $Q{http://www.jenitennison.com/xslt/xspec}result, '')"/>
      <xsl:if test="not($Q{urn:x-xspec:compile:impl}successful)">
         <xsl:message>      FAILED</xsl:message>
      </xsl:if>
      <xsl:element name="test" namespace="http://www.jenitennison.com/xslt/xspec">
         ...
         <xsl:call-template name="Q{urn:x-xspec:common:report-sequence}report-sequence">
            <xsl:with-param name="sequence" select="$Q{urn:x-xspec:compile:impl}expect-d75e20"/>
            <xsl:with-param name="report-name" select="'expect'"/>
         </xsl:call-template>
      </xsl:element>
   </xsl:template>
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario7"
      ...
      <xsl:element name="scenario" namespace="http://www.jenitennison.com/xslt/xspec">
         ...
         <xsl:variable name="Q{http://www.jenitennison.com/xslt/xspec}result" as="item()*">
            <xsl:apply-templates select="$Q{urn:x-xspec:compile:impl}context-d126e0"/>
         </xsl:variable>
         <xsl:call-template name="Q{urn:x-xspec:common:report-sequence}report-sequence">
            <xsl:with-param name="sequence"
                            select="$Q{http://www.jenitennison.com/xslt/xspec}result"/>
   ...
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario7-expect1"
      ...
      <xsl:param name="Q{http://www.jenitennison.com/xslt/xspec}result"
                 ...
                 required="yes"/>
      <xsl:message>expect it to be rendered in English</xsl:message>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}expect-d75e23-doc"
                    as="document-node()"
                    select="doc('file:/home/runner/work/xslTNG/xslTNG/src/test/resources/expected/en_important.002.html')"/>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}expect-d75e23"
                    select="$Q{urn:x-xspec:compile:impl}expect-d75e23-doc ! ( . )"><!--expected result--></xsl:variable>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}successful"
                    as="Q{http://www.w3.org/2001/XMLSchema}boolean"
                    select="Q{urn:x-xspec:common:deep-equal}deep-equal($Q{urn:x-xspec:compile:impl}expect-d75e23, $Q{http://www.jenitennison.com/xslt/xspec}result, '')"/>
      <xsl:if test="not($Q{urn:x-xspec:compile:impl}successful)">
         <xsl:message>      FAILED</xsl:message>
      </xsl:if>
      <xsl:element name="test" namespace="http://www.jenitennison.com/xslt/xspec">
         ...
         <xsl:call-template name="Q{urn:x-xspec:common:report-sequence}report-sequence">
            <xsl:with-param name="sequence" select="$Q{urn:x-xspec:compile:impl}expect-d75e23"/>
            <xsl:with-param name="report-name" select="'expect'"/>
         </xsl:call-template>
      </xsl:element>
   </xsl:template>
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario8"
      ...
      <xsl:element name="scenario" namespace="http://www.jenitennison.com/xslt/xspec">
         ...
         <xsl:variable name="Q{urn:x-xspec:compile:impl}context-d134e0-doc"
                       as="document-node()"
                       select="doc('file:/home/runner/work/xslTNG/xslTNG/src/test/resources/xml/en_caution.001.xml')"/>
         <xsl:variable name="Q{urn:x-xspec:compile:impl}context-d134e0"
                       select="$Q{urn:x-xspec:compile:impl}context-d134e0-doc ! ( . )"/>
         <xsl:variable name="Q{http://www.jenitennison.com/xslt/xspec}context"
                       as="item()*"
                       select="$Q{urn:x-xspec:compile:impl}context-d134e0"/>
         <xsl:variable name="Q{http://www.jenitennison.com/xslt/xspec}result" as="item()*">
            <xsl:apply-templates select="$Q{urn:x-xspec:compile:impl}context-d134e0"/>
         </xsl:variable>
         <xsl:call-template name="Q{urn:x-xspec:common:report-sequence}report-sequence">
            <xsl:with-param name="sequence"
                            select="$Q{http://www.jenitennison.com/xslt/xspec}result"/>
   ...
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario8-expect1"
      ...
      <xsl:variable name="Q{urn:x-xspec:compile:impl}expect-d75e26"
                    select="$Q{urn:x-xspec:compile:impl}expect-d75e26-doc ! ( . )"><!--expected result--></xsl:variable>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}successful"
                    as="Q{http://www.w3.org/2001/XMLSchema}boolean"
   ...
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario9"
      ...
      <xsl:element name="scenario" namespace="http://www.jenitennison.com/xslt/xspec">
         ...
         <xsl:variable name="Q{http://www.jenitennison.com/xslt/xspec}result" as="item()*">
            <xsl:apply-templates select="$Q{urn:x-xspec:compile:impl}context-d142e0"/>
         </xsl:variable>
         <xsl:call-template name="Q{urn:x-xspec:common:report-sequence}report-sequence">
            <xsl:with-param name="sequence"
                            select="$Q{http://www.jenitennison.com/xslt/xspec}result"/>
   ...
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario9-expect1"
      ...
      <xsl:param name="Q{http://www.jenitennison.com/xslt/xspec}result"
                 ...
                 required="yes"/>
      <xsl:message>expect it to be rendered in English</xsl:message>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}expect-d75e29-doc"
                    as="document-node()"
                    select="doc('file:/home/runner/work/xslTNG/xslTNG/src/test/resources/expected/en_caution.002.html')"/>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}expect-d75e29"
                    select="$Q{urn:x-xspec:compile:impl}expect-d75e29-doc ! ( . )"><!--expected result--></xsl:variable>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}successful"
                    as="Q{http://www.w3.org/2001/XMLSchema}boolean"
                    select="Q{urn:x-xspec:common:deep-equal}deep-equal($Q{urn:x-xspec:compile:impl}expect-d75e29, $Q{http://www.jenitennison.com/xslt/xspec}result, '')"/>
      <xsl:if test="not($Q{urn:x-xspec:compile:impl}successful)">
         <xsl:message>      FAILED</xsl:message>
      </xsl:if>
      <xsl:element name="test" namespace="http://www.jenitennison.com/xslt/xspec">
         ...
         <xsl:call-template name="Q{urn:x-xspec:common:report-sequence}report-sequence">
            <xsl:with-param name="sequence" select="$Q{urn:x-xspec:compile:impl}expect-d75e29"/>
            <xsl:with-param name="report-name" select="'expect'"/>
         </xsl:call-template>
      </xsl:element>
   </xsl:template>
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario10"
      ...
      <xsl:element name="scenario" namespace="http://www.jenitennison.com/xslt/xspec">
         ...
         <xsl:variable name="Q{urn:x-xspec:compile:impl}context-d150e0-doc"
                       as="document-node()"
                       select="doc('file:/home/runner/work/xslTNG/xslTNG/src/test/resources/xml/en_warning.001.xml')"/>
         <xsl:variable name="Q{urn:x-xspec:compile:impl}context-d150e0"
                       select="$Q{urn:x-xspec:compile:impl}context-d150e0-doc ! ( . )"/>
         <xsl:variable name="Q{http://www.jenitennison.com/xslt/xspec}context"
                       as="item()*"
                       select="$Q{urn:x-xspec:compile:impl}context-d150e0"/>
         <xsl:variable name="Q{http://www.jenitennison.com/xslt/xspec}result" as="item()*">
            <xsl:apply-templates select="$Q{urn:x-xspec:compile:impl}context-d150e0"/>
         </xsl:variable>
         <xsl:call-template name="Q{urn:x-xspec:common:report-sequence}report-sequence">
            <xsl:with-param name="sequence"
                            select="$Q{http://www.jenitennison.com/xslt/xspec}result"/>
   ...
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario10-expect1"
      ...
      <xsl:param name="Q{http://www.jenitennison.com/xslt/xspec}result"
                 ...
                 required="yes"/>
      <xsl:message>expect it to be rendered in English</xsl:message>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}expect-d75e32-doc"
                    as="document-node()"
                    select="doc('file:/home/runner/work/xslTNG/xslTNG/src/test/resources/expected/en_warning.001.html')"/>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}expect-d75e32"
                    select="$Q{urn:x-xspec:compile:impl}expect-d75e32-doc ! ( . )"><!--expected result--></xsl:variable>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}successful"
                    as="Q{http://www.w3.org/2001/XMLSchema}boolean"
                    select="Q{urn:x-xspec:common:deep-equal}deep-equal($Q{urn:x-xspec:compile:impl}expect-d75e32, $Q{http://www.jenitennison.com/xslt/xspec}result, '')"/>
      <xsl:if test="not($Q{urn:x-xspec:compile:impl}successful)">
         <xsl:message>      FAILED</xsl:message>
      </xsl:if>
      <xsl:element name="test" namespace="http://www.jenitennison.com/xslt/xspec">
         ...
         <xsl:call-template name="Q{urn:x-xspec:common:report-sequence}report-sequence">
            <xsl:with-param name="sequence" select="$Q{urn:x-xspec:compile:impl}expect-d75e32"/>
            <xsl:with-param name="report-name" select="'expect'"/>
         </xsl:call-template>
      </xsl:element>
   </xsl:template>
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario11"
      ...
      <xsl:element name="scenario" namespace="http://www.jenitennison.com/xslt/xspec">
         ...
         <xsl:variable name="Q{http://www.jenitennison.com/xslt/xspec}result" as="item()*">
            <xsl:apply-templates select="$Q{urn:x-xspec:compile:impl}context-d158e0"/>
         </xsl:variable>
         <xsl:call-template name="Q{urn:x-xspec:common:report-sequence}report-sequence">
            <xsl:with-param name="sequence"
                            select="$Q{http://www.jenitennison.com/xslt/xspec}result"/>
   ...
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario11-expect1"
      ...
      <xsl:variable name="Q{urn:x-xspec:compile:impl}expect-d75e36"
                    select="$Q{urn:x-xspec:compile:impl}expect-d75e36-doc ! ( . )"><!--expected result--></xsl:variable>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}successful"
                    as="Q{http://www.w3.org/2001/XMLSchema}boolean"
   ...
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario12"
      ...
      <xsl:element name="scenario" namespace="http://www.jenitennison.com/xslt/xspec">
         ...
         <xsl:variable name="Q{urn:x-xspec:compile:impl}context-d166e0-doc"
                       as="document-node()"
                       select="doc('file:/home/runner/work/xslTNG/xslTNG/src/test/resources/xml/en_danger.001.xml')"/>
         <xsl:variable name="Q{urn:x-xspec:compile:impl}context-d166e0"
                       select="$Q{urn:x-xspec:compile:impl}context-d166e0-doc ! ( . )"/>
         <xsl:variable name="Q{http://www.jenitennison.com/xslt/xspec}context"
                       as="item()*"
                       select="$Q{urn:x-xspec:compile:impl}context-d166e0"/>
         <xsl:variable name="Q{http://www.jenitennison.com/xslt/xspec}result" as="item()*">
            <xsl:apply-templates select="$Q{urn:x-xspec:compile:impl}context-d166e0"/>
         </xsl:variable>
         <xsl:call-template name="Q{urn:x-xspec:common:report-sequence}report-sequence">
            <xsl:with-param name="sequence"
                            select="$Q{http://www.jenitennison.com/xslt/xspec}result"/>
   ...
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario12-expect1"
      ...
      <xsl:param name="Q{http://www.jenitennison.com/xslt/xspec}result"
                 ...
                 required="yes"/>
      <xsl:message>expect it to be rendered in English</xsl:message>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}expect-d75e39-doc"
                    as="document-node()"
                    select="doc('file:/home/runner/work/xslTNG/xslTNG/src/test/resources/expected/en_danger.001.html')"/>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}expect-d75e39"
                    select="$Q{urn:x-xspec:compile:impl}expect-d75e39-doc ! ( . )"><!--expected result--></xsl:variable>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}successful"
                    as="Q{http://www.w3.org/2001/XMLSchema}boolean"
                    select="Q{urn:x-xspec:common:deep-equal}deep-equal($Q{urn:x-xspec:compile:impl}expect-d75e39, $Q{http://www.jenitennison.com/xslt/xspec}result, '')"/>
      <xsl:if test="not($Q{urn:x-xspec:compile:impl}successful)">
         <xsl:message>      FAILED</xsl:message>
      </xsl:if>
      <xsl:element name="test" namespace="http://www.jenitennison.com/xslt/xspec">
         ...
         <xsl:call-template name="Q{urn:x-xspec:common:report-sequence}report-sequence">
            <xsl:with-param name="sequence" select="$Q{urn:x-xspec:compile:impl}expect-d75e39"/>
            <xsl:with-param name="report-name" select="'expect'"/>
         </xsl:call-template>
      </xsl:element>
   </xsl:template>
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario13"
      ...
      <xsl:element name="scenario" namespace="http://www.jenitennison.com/xslt/xspec">
         ...
         <xsl:variable name="Q{http://www.jenitennison.com/xslt/xspec}result" as="item()*">
            <xsl:apply-templates select="$Q{urn:x-xspec:compile:impl}context-d174e0"/>
         </xsl:variable>
         <xsl:call-template name="Q{urn:x-xspec:common:report-sequence}report-sequence">
            <xsl:with-param name="sequence"
                            select="$Q{http://www.jenitennison.com/xslt/xspec}result"/>
   ...
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario13-expect1"
      ...
      <xsl:param name="Q{http://www.jenitennison.com/xslt/xspec}result"
                 ...
                 required="yes"/>
      <xsl:message>expect it to be rendered in English</xsl:message>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}expect-d75e42-doc"
                    as="document-node()"
                    select="doc('file:/home/runner/work/xslTNG/xslTNG/src/test/resources/expected/en_danger.002.html')"/>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}expect-d75e42"
                    select="$Q{urn:x-xspec:compile:impl}expect-d75e42-doc ! ( . )"><!--expected result--></xsl:variable>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}successful"
                    as="Q{http://www.w3.org/2001/XMLSchema}boolean"
                    select="Q{urn:x-xspec:common:deep-equal}deep-equal($Q{urn:x-xspec:compile:impl}expect-d75e42, $Q{http://www.jenitennison.com/xslt/xspec}result, '')"/>
      <xsl:if test="not($Q{urn:x-xspec:compile:impl}successful)">
         <xsl:message>      FAILED</xsl:message>
      </xsl:if>
      <xsl:element name="test" namespace="http://www.jenitennison.com/xslt/xspec">
         ...
         <xsl:call-template name="Q{urn:x-xspec:common:report-sequence}report-sequence">
            <xsl:with-param name="sequence" select="$Q{urn:x-xspec:compile:impl}expect-d75e42"/>
            <xsl:with-param name="report-name" select="'expect'"/>
         </xsl:call-template>
      </xsl:element>
   </xsl:template>
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario14"
      ...
      <xsl:element name="scenario" namespace="http://www.jenitennison.com/xslt/xspec">
         ...
         <xsl:variable name="Q{urn:x-xspec:compile:impl}context-d182e0-doc"
                       as="document-node()"
                       select="doc('file:/home/runner/work/xslTNG/xslTNG/src/test/resources/xml/fr_note.001.xml')"/>
         <xsl:variable name="Q{urn:x-xspec:compile:impl}context-d182e0"
                       select="$Q{urn:x-xspec:compile:impl}context-d182e0-doc ! ( . )"/>
         <xsl:variable name="Q{http://www.jenitennison.com/xslt/xspec}context"
                       as="item()*"
                       select="$Q{urn:x-xspec:compile:impl}context-d182e0"/>
         <xsl:variable name="Q{http://www.jenitennison.com/xslt/xspec}result" as="item()*">
            <xsl:apply-templates select="$Q{urn:x-xspec:compile:impl}context-d182e0"/>
         </xsl:variable>
         <xsl:call-template name="Q{urn:x-xspec:common:report-sequence}report-sequence">
            <xsl:with-param name="sequence"
                            select="$Q{http://www.jenitennison.com/xslt/xspec}result"/>
   ...
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario14-expect1"
      ...
      <xsl:variable name="Q{urn:x-xspec:compile:impl}expect-d75e45-doc"
                    as="document-node()"
                    select="doc('file:/home/runner/work/xslTNG/xslTNG/src/test/resources/expected/fr_note.001.html')"/>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}expect-d75e45"
                    select="$Q{urn:x-xspec:compile:impl}expect-d75e45-doc ! ( . )"><!--expected result--></xsl:variable>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}successful"
                    as="Q{http://www.w3.org/2001/XMLSchema}boolean"
                    select="Q{urn:x-xspec:common:deep-equal}deep-equal($Q{urn:x-xspec:compile:impl}expect-d75e45, $Q{http://www.jenitennison.com/xslt/xspec}result, '')"/>
      <xsl:if test="not($Q{urn:x-xspec:compile:impl}successful)">
         <xsl:message>      FAILED</xsl:message>
      </xsl:if>
      <xsl:element name="test" namespace="http://www.jenitennison.com/xslt/xspec">
         ...
         <xsl:call-template name="Q{urn:x-xspec:common:report-sequence}report-sequence">
            <xsl:with-param name="sequence" select="$Q{urn:x-xspec:compile:impl}expect-d75e45"/>
            <xsl:with-param name="report-name" select="'expect'"/>
         </xsl:call-template>
      </xsl:element>
   </xsl:template>
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario15"
      ...
      <xsl:element name="scenario" namespace="http://www.jenitennison.com/xslt/xspec">
         ...
         <xsl:variable name="Q{http://www.jenitennison.com/xslt/xspec}result" as="item()*">
            <xsl:apply-templates select="$Q{urn:x-xspec:compile:impl}context-d190e0"/>
         </xsl:variable>
         <xsl:call-template name="Q{urn:x-xspec:common:report-sequence}report-sequence">
            <xsl:with-param name="sequence"
                            select="$Q{http://www.jenitennison.com/xslt/xspec}result"/>
   ...
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario15-expect1"
      ...
      <xsl:param name="Q{http://www.jenitennison.com/xslt/xspec}result"
                 ...
                 required="yes"/>
      <xsl:message>expect it to be rendered in French</xsl:message>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}expect-d75e48-doc"
                    as="document-node()"
                    select="doc('file:/home/runner/work/xslTNG/xslTNG/src/test/resources/expected/fr_note.002.html')"/>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}expect-d75e48"
                    select="$Q{urn:x-xspec:compile:impl}expect-d75e48-doc ! ( . )"><!--expected result--></xsl:variable>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}successful"
                    as="Q{http://www.w3.org/2001/XMLSchema}boolean"
                    select="Q{urn:x-xspec:common:deep-equal}deep-equal($Q{urn:x-xspec:compile:impl}expect-d75e48, $Q{http://www.jenitennison.com/xslt/xspec}result, '')"/>
      <xsl:if test="not($Q{urn:x-xspec:compile:impl}successful)">
         <xsl:message>      FAILED</xsl:message>
      </xsl:if>
      <xsl:element name="test" namespace="http://www.jenitennison.com/xslt/xspec">
         ...
         <xsl:call-template name="Q{urn:x-xspec:common:report-sequence}report-sequence">
            <xsl:with-param name="sequence" select="$Q{urn:x-xspec:compile:impl}expect-d75e48"/>
            <xsl:with-param name="report-name" select="'expect'"/>
         </xsl:call-template>
      </xsl:element>
   </xsl:template>
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario16"
      ...
      <xsl:element name="scenario" namespace="http://www.jenitennison.com/xslt/xspec">
         ...
         <xsl:variable name="Q{urn:x-xspec:compile:impl}context-d198e0"
                       select="$Q{urn:x-xspec:compile:impl}context-d198e0-doc ! ( . )"/>
         <xsl:variable name="Q{http://www.jenitennison.com/xslt/xspec}context"
                       as="item()*"
   ...
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario16-expect1"
      ...
      <xsl:param name="Q{http://www.jenitennison.com/xslt/xspec}result"
                 ...
                 required="yes"/>
      <xsl:message>expect it to be rendered in French</xsl:message>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}expect-d75e51-doc"
                    as="document-node()"
                    select="doc('file:/home/runner/work/xslTNG/xslTNG/src/test/resources/expected/fr_note.003.html')"/>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}expect-d75e51"
                    select="$Q{urn:x-xspec:compile:impl}expect-d75e51-doc ! ( . )"><!--expected result--></xsl:variable>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}successful"
                    as="Q{http://www.w3.org/2001/XMLSchema}boolean"
                    select="Q{urn:x-xspec:common:deep-equal}deep-equal($Q{urn:x-xspec:compile:impl}expect-d75e51, $Q{http://www.jenitennison.com/xslt/xspec}result, '')"/>
      <xsl:if test="not($Q{urn:x-xspec:compile:impl}successful)">
         <xsl:message>      FAILED</xsl:message>
      </xsl:if>
      <xsl:element name="test" namespace="http://www.jenitennison.com/xslt/xspec">
         ...
         <xsl:call-template name="Q{urn:x-xspec:common:report-sequence}report-sequence">
            <xsl:with-param name="sequence" select="$Q{urn:x-xspec:compile:impl}expect-d75e51"/>
            <xsl:with-param name="report-name" select="'expect'"/>
         </xsl:call-template>
      </xsl:element>
   </xsl:template>
   ...
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario17-expect1"
      ...
      <xsl:param name="Q{http://www.jenitennison.com/xslt/xspec}result"
                 ...
                 required="yes"/>
      <xsl:message>expect it to be rendered in French</xsl:message>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}expect-d75e54-doc"
                    as="document-node()"
                    select="doc('file:/home/runner/work/xslTNG/xslTNG/src/test/resources/expected/fr_tip.001.html')"/>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}expect-d75e54"
                    select="$Q{urn:x-xspec:compile:impl}expect-d75e54-doc ! ( . )"><!--expected result--></xsl:variable>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}successful"
                    as="Q{http://www.w3.org/2001/XMLSchema}boolean"
                    select="Q{urn:x-xspec:common:deep-equal}deep-equal($Q{urn:x-xspec:compile:impl}expect-d75e54, $Q{http://www.jenitennison.com/xslt/xspec}result, '')"/>
      <xsl:if test="not($Q{urn:x-xspec:compile:impl}successful)">
         <xsl:message>      FAILED</xsl:message>
      </xsl:if>
      <xsl:element name="test" namespace="http://www.jenitennison.com/xslt/xspec">
         ...
         <xsl:call-template name="Q{urn:x-xspec:common:report-sequence}report-sequence">
            <xsl:with-param name="sequence" select="$Q{urn:x-xspec:compile:impl}expect-d75e54"/>
            <xsl:with-param name="report-name" select="'expect'"/>
         </xsl:call-template>
      </xsl:element>
   </xsl:template>
   ...
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario18-expect1"
      ...
      <xsl:param name="Q{http://www.jenitennison.com/xslt/xspec}result"
                 ...
                 required="yes"/>
      <xsl:message>expect it to be rendered in French</xsl:message>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}expect-d75e57-doc"
                    as="document-node()"
                    select="doc('file:/home/runner/work/xslTNG/xslTNG/src/test/resources/expected/fr_tip.002.html')"/>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}expect-d75e57"
                    select="$Q{urn:x-xspec:compile:impl}expect-d75e57-doc ! ( . )"><!--expected result--></xsl:variable>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}successful"
                    as="Q{http://www.w3.org/2001/XMLSchema}boolean"
                    select="Q{urn:x-xspec:common:deep-equal}deep-equal($Q{urn:x-xspec:compile:impl}expect-d75e57, $Q{http://www.jenitennison.com/xslt/xspec}result, '')"/>
      <xsl:if test="not($Q{urn:x-xspec:compile:impl}successful)">
         <xsl:message>      FAILED</xsl:message>
      </xsl:if>
      <xsl:element name="test" namespace="http://www.jenitennison.com/xslt/xspec">
         ...
         <xsl:call-template name="Q{urn:x-xspec:common:report-sequence}report-sequence">
            <xsl:with-param name="sequence" select="$Q{urn:x-xspec:compile:impl}expect-d75e57"/>
            <xsl:with-param name="report-name" select="'expect'"/>
         </xsl:call-template>
      </xsl:element>
   </xsl:template>
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario19"
      ...
      <xsl:element name="scenario" namespace="http://www.jenitennison.com/xslt/xspec">
         ...
         <xsl:variable name="Q{urn:x-xspec:compile:impl}context-d222e0"
                       select="$Q{urn:x-xspec:compile:impl}context-d222e0-doc ! ( . )"/>
         <xsl:variable name="Q{http://www.jenitennison.com/xslt/xspec}context"
                       as="item()*"
   ...
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario19-expect1"
      ...
      <xsl:param name="Q{http://www.jenitennison.com/xslt/xspec}result"
                 ...
                 required="yes"/>
      <xsl:message>expect it to be rendered in French</xsl:message>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}expect-d75e60-doc"
                    as="document-node()"
                    select="doc('file:/home/runner/work/xslTNG/xslTNG/src/test/resources/expected/fr_important.001.html')"/>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}expect-d75e60"
                    select="$Q{urn:x-xspec:compile:impl}expect-d75e60-doc ! ( . )"><!--expected result--></xsl:variable>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}successful"
                    as="Q{http://www.w3.org/2001/XMLSchema}boolean"
                    select="Q{urn:x-xspec:common:deep-equal}deep-equal($Q{urn:x-xspec:compile:impl}expect-d75e60, $Q{http://www.jenitennison.com/xslt/xspec}result, '')"/>
      <xsl:if test="not($Q{urn:x-xspec:compile:impl}successful)">
         <xsl:message>      FAILED</xsl:message>
      </xsl:if>
      <xsl:element name="test" namespace="http://www.jenitennison.com/xslt/xspec">
         ...
         <xsl:call-template name="Q{urn:x-xspec:common:report-sequence}report-sequence">
            <xsl:with-param name="sequence" select="$Q{urn:x-xspec:compile:impl}expect-d75e60"/>
            <xsl:with-param name="report-name" select="'expect'"/>
         </xsl:call-template>
      </xsl:element>
   </xsl:template>
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario20"
      ...
      <xsl:element name="scenario" namespace="http://www.jenitennison.com/xslt/xspec">
         ...
         <xsl:variable name="Q{urn:x-xspec:compile:impl}context-d230e0"
                       select="$Q{urn:x-xspec:compile:impl}context-d230e0-doc ! ( . )"/>
         <xsl:variable name="Q{http://www.jenitennison.com/xslt/xspec}context"
                       as="item()*"
   ...
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario20-expect1"
      ...
      <xsl:param name="Q{http://www.jenitennison.com/xslt/xspec}result"
                 ...
                 required="yes"/>
      <xsl:message>expect it to be rendered in French</xsl:message>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}expect-d75e63-doc"
                    as="document-node()"
                    select="doc('file:/home/runner/work/xslTNG/xslTNG/src/test/resources/expected/fr_important.002.html')"/>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}expect-d75e63"
                    select="$Q{urn:x-xspec:compile:impl}expect-d75e63-doc ! ( . )"><!--expected result--></xsl:variable>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}successful"
                    as="Q{http://www.w3.org/2001/XMLSchema}boolean"
                    select="Q{urn:x-xspec:common:deep-equal}deep-equal($Q{urn:x-xspec:compile:impl}expect-d75e63, $Q{http://www.jenitennison.com/xslt/xspec}result, '')"/>
      <xsl:if test="not($Q{urn:x-xspec:compile:impl}successful)">
         <xsl:message>      FAILED</xsl:message>
      </xsl:if>
      <xsl:element name="test" namespace="http://www.jenitennison.com/xslt/xspec">
         ...
         <xsl:call-template name="Q{urn:x-xspec:common:report-sequence}report-sequence">
            <xsl:with-param name="sequence" select="$Q{urn:x-xspec:compile:impl}expect-d75e63"/>
            <xsl:with-param name="report-name" select="'expect'"/>
         </xsl:call-template>
      </xsl:element>
   </xsl:template>
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario21"
      ...
      <xsl:element name="scenario" namespace="http://www.jenitennison.com/xslt/xspec">
         ...
         <xsl:variable name="Q{urn:x-xspec:compile:impl}context-d238e0"
   ...
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario21-expect1"
      ...
      <xsl:param name="Q{http://www.jenitennison.com/xslt/xspec}result"
                 ...
                 required="yes"/>
      <xsl:message>expect it to be rendered in French</xsl:message>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}expect-d75e66-doc"
                    as="document-node()"
                    select="doc('file:/home/runner/work/xslTNG/xslTNG/src/test/resources/expected/fr_caution.001.html')"/>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}expect-d75e66"
                    select="$Q{urn:x-xspec:compile:impl}expect-d75e66-doc ! ( . )"><!--expected result--></xsl:variable>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}successful"
                    as="Q{http://www.w3.org/2001/XMLSchema}boolean"
                    select="Q{urn:x-xspec:common:deep-equal}deep-equal($Q{urn:x-xspec:compile:impl}expect-d75e66, $Q{http://www.jenitennison.com/xslt/xspec}result, '')"/>
      <xsl:if test="not($Q{urn:x-xspec:compile:impl}successful)">
         <xsl:message>      FAILED</xsl:message>
      </xsl:if>
      <xsl:element name="test" namespace="http://www.jenitennison.com/xslt/xspec">
         ...
         <xsl:call-template name="Q{urn:x-xspec:common:report-sequence}report-sequence">
            <xsl:with-param name="sequence" select="$Q{urn:x-xspec:compile:impl}expect-d75e66"/>
            <xsl:with-param name="report-name" select="'expect'"/>
         </xsl:call-template>
      </xsl:element>
   </xsl:template>
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario22"
      ...
      <xsl:element name="scenario" namespace="http://www.jenitennison.com/xslt/xspec">
         ...
         <xsl:variable name="Q{urn:x-xspec:compile:impl}context-d246e0-doc"
                       as="document-node()"
                       select="doc('file:/home/runner/work/xslTNG/xslTNG/src/test/resources/xml/fr_caution.002.xml')"/>
         <xsl:variable name="Q{urn:x-xspec:compile:impl}context-d246e0"
                       select="$Q{urn:x-xspec:compile:impl}context-d246e0-doc ! ( . )"/>
         <xsl:variable name="Q{http://www.jenitennison.com/xslt/xspec}context"
                       as="item()*"
                       select="$Q{urn:x-xspec:compile:impl}context-d246e0"/>
         <xsl:variable name="Q{http://www.jenitennison.com/xslt/xspec}result" as="item()*">
            <xsl:apply-templates select="$Q{urn:x-xspec:compile:impl}context-d246e0"/>
         </xsl:variable>
         <xsl:call-template name="Q{urn:x-xspec:common:report-sequence}report-sequence">
            <xsl:with-param name="sequence"
                            select="$Q{http://www.jenitennison.com/xslt/xspec}result"/>
   ...
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario22-expect1"
      ...
      <xsl:param name="Q{http://www.jenitennison.com/xslt/xspec}result"
                 ...
                 required="yes"/>
      <xsl:message>expect it to be rendered in French</xsl:message>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}expect-d75e70-doc"
                    as="document-node()"
                    select="doc('file:/home/runner/work/xslTNG/xslTNG/src/test/resources/expected/fr_caution.002.html')"/>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}expect-d75e70"
                    select="$Q{urn:x-xspec:compile:impl}expect-d75e70-doc ! ( . )"><!--expected result--></xsl:variable>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}successful"
                    as="Q{http://www.w3.org/2001/XMLSchema}boolean"
                    select="Q{urn:x-xspec:common:deep-equal}deep-equal($Q{urn:x-xspec:compile:impl}expect-d75e70, $Q{http://www.jenitennison.com/xslt/xspec}result, '')"/>
      <xsl:if test="not($Q{urn:x-xspec:compile:impl}successful)">
         <xsl:message>      FAILED</xsl:message>
      </xsl:if>
      <xsl:element name="test" namespace="http://www.jenitennison.com/xslt/xspec">
         ...
         <xsl:call-template name="Q{urn:x-xspec:common:report-sequence}report-sequence">
            <xsl:with-param name="sequence" select="$Q{urn:x-xspec:compile:impl}expect-d75e70"/>
            <xsl:with-param name="report-name" select="'expect'"/>
         </xsl:call-template>
      </xsl:element>
   </xsl:template>
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario23"
      ...
      <xsl:element name="scenario" namespace="http://www.jenitennison.com/xslt/xspec">
         ...
         <xsl:variable name="Q{urn:x-xspec:compile:impl}context-d254e0-doc"
                       as="document-node()"
                       select="doc('file:/home/runner/work/xslTNG/xslTNG/src/test/resources/xml/fr_warning.001.xml')"/>
         <xsl:variable name="Q{urn:x-xspec:compile:impl}context-d254e0"
                       select="$Q{urn:x-xspec:compile:impl}context-d254e0-doc ! ( . )"/>
         <xsl:variable name="Q{http://www.jenitennison.com/xslt/xspec}context"
                       as="item()*"
                       select="$Q{urn:x-xspec:compile:impl}context-d254e0"/>
         <xsl:variable name="Q{http://www.jenitennison.com/xslt/xspec}result" as="item()*">
            <xsl:apply-templates select="$Q{urn:x-xspec:compile:impl}context-d254e0"/>
         </xsl:variable>
         <xsl:call-template name="Q{urn:x-xspec:common:report-sequence}report-sequence">
            <xsl:with-param name="sequence"
                            select="$Q{http://www.jenitennison.com/xslt/xspec}result"/>
   ...
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario23-expect1"
      ...
      <xsl:param name="Q{http://www.jenitennison.com/xslt/xspec}result"
                 ...
                 required="yes"/>
      <xsl:message>expect it to be rendered in French</xsl:message>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}expect-d75e73-doc"
                    as="document-node()"
                    select="doc('file:/home/runner/work/xslTNG/xslTNG/src/test/resources/expected/fr_warning.001.html')"/>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}expect-d75e73"
                    select="$Q{urn:x-xspec:compile:impl}expect-d75e73-doc ! ( . )"><!--expected result--></xsl:variable>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}successful"
                    as="Q{http://www.w3.org/2001/XMLSchema}boolean"
                    select="Q{urn:x-xspec:common:deep-equal}deep-equal($Q{urn:x-xspec:compile:impl}expect-d75e73, $Q{http://www.jenitennison.com/xslt/xspec}result, '')"/>
      <xsl:if test="not($Q{urn:x-xspec:compile:impl}successful)">
         <xsl:message>      FAILED</xsl:message>
      </xsl:if>
      <xsl:element name="test" namespace="http://www.jenitennison.com/xslt/xspec">
         ...
         <xsl:call-template name="Q{urn:x-xspec:common:report-sequence}report-sequence">
            <xsl:with-param name="sequence" select="$Q{urn:x-xspec:compile:impl}expect-d75e73"/>
            <xsl:with-param name="report-name" select="'expect'"/>
         </xsl:call-template>
      </xsl:element>
   </xsl:template>
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario24"
      ...
      <xsl:element name="scenario" namespace="http://www.jenitennison.com/xslt/xspec">
         ...
         <xsl:variable name="Q{urn:x-xspec:compile:impl}context-d262e0-doc"
                       as="document-node()"
                       select="doc('file:/home/runner/work/xslTNG/xslTNG/src/test/resources/xml/fr_warning.002.xml')"/>
         <xsl:variable name="Q{urn:x-xspec:compile:impl}context-d262e0"
                       select="$Q{urn:x-xspec:compile:impl}context-d262e0-doc ! ( . )"/>
         <xsl:variable name="Q{http://www.jenitennison.com/xslt/xspec}context"
                       as="item()*"
                       select="$Q{urn:x-xspec:compile:impl}context-d262e0"/>
         <xsl:variable name="Q{http://www.jenitennison.com/xslt/xspec}result" as="item()*">
            <xsl:apply-templates select="$Q{urn:x-xspec:compile:impl}context-d262e0"/>
         </xsl:variable>
         <xsl:call-template name="Q{urn:x-xspec:common:report-sequence}report-sequence">
            <xsl:with-param name="sequence"
                            select="$Q{http://www.jenitennison.com/xslt/xspec}result"/>
   ...
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario24-expect1"
      ...
      <xsl:param name="Q{http://www.jenitennison.com/xslt/xspec}result"
                 ...
                 required="yes"/>
      <xsl:message>expect it to be rendered in French</xsl:message>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}expect-d75e76-doc"
                    as="document-node()"
                    select="doc('file:/home/runner/work/xslTNG/xslTNG/src/test/resources/expected/fr_warning.002.html')"/>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}expect-d75e76"
                    select="$Q{urn:x-xspec:compile:impl}expect-d75e76-doc ! ( . )"><!--expected result--></xsl:variable>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}successful"
                    as="Q{http://www.w3.org/2001/XMLSchema}boolean"
                    select="Q{urn:x-xspec:common:deep-equal}deep-equal($Q{urn:x-xspec:compile:impl}expect-d75e76, $Q{http://www.jenitennison.com/xslt/xspec}result, '')"/>
      <xsl:if test="not($Q{urn:x-xspec:compile:impl}successful)">
         <xsl:message>      FAILED</xsl:message>
      </xsl:if>
      <xsl:element name="test" namespace="http://www.jenitennison.com/xslt/xspec">
         ...
         <xsl:call-template name="Q{urn:x-xspec:common:report-sequence}report-sequence">
            <xsl:with-param name="sequence" select="$Q{urn:x-xspec:compile:impl}expect-d75e76"/>
            <xsl:with-param name="report-name" select="'expect'"/>
         </xsl:call-template>
      </xsl:element>
   </xsl:template>
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario25"
      ...
      <xsl:element name="scenario" namespace="http://www.jenitennison.com/xslt/xspec">
         ...
         <xsl:variable name="Q{urn:x-xspec:compile:impl}context-d270e0-doc"
                       as="document-node()"
                       select="doc('file:/home/runner/work/xslTNG/xslTNG/src/test/resources/xml/fr_danger.001.xml')"/>
         <xsl:variable name="Q{urn:x-xspec:compile:impl}context-d270e0"
                       select="$Q{urn:x-xspec:compile:impl}context-d270e0-doc ! ( . )"/>
         <xsl:variable name="Q{http://www.jenitennison.com/xslt/xspec}context"
                       as="item()*"
                       select="$Q{urn:x-xspec:compile:impl}context-d270e0"/>
         <xsl:variable name="Q{http://www.jenitennison.com/xslt/xspec}result" as="item()*">
            <xsl:apply-templates select="$Q{urn:x-xspec:compile:impl}context-d270e0"/>
         </xsl:variable>
         <xsl:call-template name="Q{urn:x-xspec:common:report-sequence}report-sequence">
            <xsl:with-param name="sequence"
                            select="$Q{http://www.jenitennison.com/xslt/xspec}result"/>
   ...
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario25-expect1"
      ...
      <xsl:variable name="Q{urn:x-xspec:compile:impl}expect-d75e79"
                    select="$Q{urn:x-xspec:compile:impl}expect-d75e79-doc ! ( . )"><!--expected result--></xsl:variable>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}successful"
                    as="Q{http://www.w3.org/2001/XMLSchema}boolean"
   ...
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario26"
      ...
      <xsl:element name="scenario" namespace="http://www.jenitennison.com/xslt/xspec">
         ...
         <xsl:variable name="Q{urn:x-xspec:compile:impl}context-d278e0-doc"
                       as="document-node()"
                       select="doc('file:/home/runner/work/xslTNG/xslTNG/src/test/resources/xml/fr_danger.002.xml')"/>
         <xsl:variable name="Q{urn:x-xspec:compile:impl}context-d278e0"
                       select="$Q{urn:x-xspec:compile:impl}context-d278e0-doc ! ( . )"/>
         <xsl:variable name="Q{http://www.jenitennison.com/xslt/xspec}context"
                       as="item()*"
                       select="$Q{urn:x-xspec:compile:impl}context-d278e0"/>
         <xsl:variable name="Q{http://www.jenitennison.com/xslt/xspec}result" as="item()*">
            <xsl:apply-templates select="$Q{urn:x-xspec:compile:impl}context-d278e0"/>
         </xsl:variable>
         <xsl:call-template name="Q{urn:x-xspec:common:report-sequence}report-sequence">
            <xsl:with-param name="sequence"
                            select="$Q{http://www.jenitennison.com/xslt/xspec}result"/>
   ...
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario26-expect1"
      ...
      <xsl:param name="Q{http://www.jenitennison.com/xslt/xspec}result"
                 ...
                 required="yes"/>
      <xsl:message>expect it to be rendered in French</xsl:message>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}expect-d75e82-doc"
                    as="document-node()"
                    select="doc('file:/home/runner/work/xslTNG/xslTNG/src/test/resources/expected/fr_danger.002.html')"/>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}expect-d75e82"
                    select="$Q{urn:x-xspec:compile:impl}expect-d75e82-doc ! ( . )"><!--expected result--></xsl:variable>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}successful"
                    as="Q{http://www.w3.org/2001/XMLSchema}boolean"
                    select="Q{urn:x-xspec:common:deep-equal}deep-equal($Q{urn:x-xspec:compile:impl}expect-d75e82, $Q{http://www.jenitennison.com/xslt/xspec}result, '')"/>
      <xsl:if test="not($Q{urn:x-xspec:compile:impl}successful)">
         <xsl:message>      FAILED</xsl:message>
      </xsl:if>
      <xsl:element name="test" namespace="http://www.jenitennison.com/xslt/xspec">
         ...
         <xsl:call-template name="Q{urn:x-xspec:common:report-sequence}report-sequence">
            <xsl:with-param name="sequence" select="$Q{urn:x-xspec:compile:impl}expect-d75e82"/>
            <xsl:with-param name="report-name" select="'expect'"/>
         </xsl:call-template>
      </xsl:element>
   </xsl:template>
