...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
   ...
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario1"
      ...
      <xsl:element name="scenario" namespace="http://www.jenitennison.com/xslt/xspec">
         ...
         <xsl:variable xmlns="http://docbook.org/ns/docbook"
                       ...
                       name="Q{urn:x-xspec:compile:impl}context-d53e0"
                       select="$Q{urn:x-xspec:compile:impl}context-d53e0-doc ! ( //db:para[@xml:id='dtformat-fr']/db:date )"/>
   ...
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario1-expect1"
      ...
      <xsl:variable name="Q{urn:x-xspec:compile:impl}expect-d50e4" select="()"><!--expected result--></xsl:variable>
