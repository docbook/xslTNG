...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
   ...
   <xsl:import href="file:/home/runner/work/xslTNG/xslTNG/build/env/formal-objects-inherit-from-division-component.xsl"/>
   <!-- XSpec library modules providing tools -->
   <xsl:include href="file:/home/runner/work/xslTNG/xslTNG/build/xspec-2.2.4/src/common/runtime-utils.xsl"/>
   <xsl:variable name="Q{http://www.jenitennison.com/xslt/xspec}stylesheet-uri"
                 as="Q{http://www.w3.org/2001/XMLSchema}anyURI">file:/home/runner/work/xslTNG/xslTNG/build/env/formal-objects-inherit-from-division-component.xsl</xsl:variable>
   <xsl:variable name="Q{http://www.jenitennison.com/xslt/xspec}xspec-uri"
                 as="Q{http://www.w3.org/2001/XMLSchema}anyURI">file:/home/runner/work/xslTNG/xslTNG/build/xspec/formal-objects-inherit-from-division-component.xspec</xsl:variable>
   ...
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}main"
      ...
      <xsl:result-document format="Q{{http://www.jenitennison.com/xslt/xspec}}xml-report-serialization-parameters">
         <xsl:element name="report" namespace="http://www.jenitennison.com/xslt/xspec">
            <xsl:attribute name="xspec" namespace="">file:/home/runner/work/xslTNG/xslTNG/build/xspec/formal-objects-inherit-from-division-component.xspec</xsl:attribute>
            <xsl:attribute name="stylesheet" namespace="">file:/home/runner/work/xslTNG/xslTNG/build/env/formal-objects-inherit-from-division-component.xsl</xsl:attribute>
   ...
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario1"
      ...
      <xsl:context-item use="absent"/>
      <xsl:message>When transforming figures-inherit-from-division-component</xsl:message>
      <xsl:element name="scenario" namespace="http://www.jenitennison.com/xslt/xspec">
         <xsl:attribute name="id" namespace="">scenario1</xsl:attribute>
         <xsl:attribute name="xspec" namespace="">file:/home/runner/work/xslTNG/xslTNG/build/xspec/formal-objects-inherit-from-division-component.xspec</xsl:attribute>
         <xsl:element name="label" namespace="http://www.jenitennison.com/xslt/xspec">
            <xsl:text>When transforming figures-inherit-from-division-component</xsl:text>
         </xsl:element>
   ...
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario1-expect1"
      ...
      <xsl:param name="Q{http://www.jenitennison.com/xslt/xspec}result"
                 as="item()*"
                 required="yes"/>
      <xsl:message>expect figures-inherit-from-division-component.expected</xsl:message>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}expect-d51e4-doc"
                    as="document-node()"
                    select="doc('file:/home/runner/work/xslTNG/xslTNG/src/test/resources/expected/figures-inherit-from-division-component.html')"/>
      ...
      <xsl:element name="test" namespace="http://www.jenitennison.com/xslt/xspec">
         ...
         <xsl:element name="label" namespace="http://www.jenitennison.com/xslt/xspec">
            <xsl:text>expect figures-inherit-from-division-component.expected</xsl:text>
         </xsl:element>
         <xsl:call-template name="Q{urn:x-xspec:common:report-sequence}report-sequence">
   ...
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario2"
                 as="element(Q{http://www.jenitennison.com/xslt/xspec}scenario)">
      <xsl:context-item use="absent"/>
      <xsl:message>When transforming formal-objects-inherit-from-division-component</xsl:message>
      <xsl:element name="scenario" namespace="http://www.jenitennison.com/xslt/xspec">
         <xsl:attribute name="id" namespace="">scenario2</xsl:attribute>
         <xsl:attribute name="xspec" namespace="">file:/home/runner/work/xslTNG/xslTNG/build/xspec/formal-objects-inherit-from-division-component.xspec</xsl:attribute>
         <xsl:element name="label" namespace="http://www.jenitennison.com/xslt/xspec">
            <xsl:text>When transforming formal-objects-inherit-from-division-component</xsl:text>
         </xsl:element>
         <xsl:element name="input-wrap" namespace="">
            <xsl:element name="x:context" namespace="http://www.jenitennison.com/xslt/xspec">
   ...
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario2-expect1"
      ...
      <xsl:param name="Q{http://www.jenitennison.com/xslt/xspec}result"
                 as="item()*"
                 required="yes"/>
      <xsl:message>expect formal-objects-inherit-from-division-component.expected</xsl:message>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}expect-d51e7-doc"
                    as="document-node()"
                    select="doc('file:/home/runner/work/xslTNG/xslTNG/src/test/resources/expected/formal-objects-inherit-from-division-component.html')"/>
      ...
      <xsl:element name="test" namespace="http://www.jenitennison.com/xslt/xspec">
         ...
         <xsl:attribute name="successful"
                        ...
                        select="$Q{urn:x-xspec:compile:impl}successful"/>
         <xsl:element name="label" namespace="http://www.jenitennison.com/xslt/xspec">
            <xsl:text>expect formal-objects-inherit-from-division-component.expected</xsl:text>
         </xsl:element>
         <xsl:call-template name="Q{urn:x-xspec:common:report-sequence}report-sequence">
