...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
   ...
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario1"
      ...
      <xsl:element name="scenario" namespace="http://www.jenitennison.com/xslt/xspec">
         ...
         <xsl:variable name="Q{http://www.jenitennison.com/xslt/xspec}result" as="item()*">
            <xsl:apply-templates select="$Q{urn:x-xspec:compile:impl}context-d60e0"/>
         </xsl:variable>
   ...
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario1-expect1"
      ...
      <xsl:variable name="Q{urn:x-xspec:compile:impl}expect-d57e4"
                    select="$Q{urn:x-xspec:compile:impl}expect-d57e4-doc ! ( . )"><!--expected result--></xsl:variable>
   ...
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario2-expect1"
      ...
      <xsl:variable name="Q{urn:x-xspec:compile:impl}expect-d57e7"
                    select="$Q{urn:x-xspec:compile:impl}expect-d57e7-doc ! ( . )"><!--expected result--></xsl:variable>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}successful"
                    as="Q{http://www.w3.org/2001/XMLSchema}boolean"
   ...
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario3-expect1"
      ...
      <xsl:variable name="Q{urn:x-xspec:compile:impl}expect-d57e10"
                    select="$Q{urn:x-xspec:compile:impl}expect-d57e10-doc ! ( . )"><!--expected result--></xsl:variable>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}successful"
                    as="Q{http://www.w3.org/2001/XMLSchema}boolean"
   ...
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario4-expect1"
      ...
      <xsl:variable name="Q{urn:x-xspec:compile:impl}expect-d57e13"
                    select="$Q{urn:x-xspec:compile:impl}expect-d57e13-doc ! ( . )"><!--expected result--></xsl:variable>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}successful"
                    as="Q{http://www.w3.org/2001/XMLSchema}boolean"
   ...
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario5-expect1"
      ...
      <xsl:variable name="Q{urn:x-xspec:compile:impl}expect-d57e16"
                    select="$Q{urn:x-xspec:compile:impl}expect-d57e16-doc ! ( . )"><!--expected result--></xsl:variable>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}successful"
                    as="Q{http://www.w3.org/2001/XMLSchema}boolean"
   ...
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario6-expect1"
      ...
      <xsl:variable name="Q{urn:x-xspec:compile:impl}expect-d57e19"
                    select="$Q{urn:x-xspec:compile:impl}expect-d57e19-doc ! ( . )"><!--expected result--></xsl:variable>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}successful"
                    as="Q{http://www.w3.org/2001/XMLSchema}boolean"
   ...
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario7-expect1"
      ...
      <xsl:variable name="Q{urn:x-xspec:compile:impl}expect-d57e22"
                    select="$Q{urn:x-xspec:compile:impl}expect-d57e22-doc ! ( . )"><!--expected result--></xsl:variable>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}successful"
                    as="Q{http://www.w3.org/2001/XMLSchema}boolean"
   ...
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario8-expect1"
      ...
      <xsl:variable name="Q{urn:x-xspec:compile:impl}expect-d57e25-doc"
                    as="document-node()"
                    select="doc('file:/home/runner/work/xslTNG/xslTNG/src/test/resources/expected/glossary.011.html')"/>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}expect-d57e25"
                    select="$Q{urn:x-xspec:compile:impl}expect-d57e25-doc ! ( . )"><!--expected result--></xsl:variable>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}successful"
                    as="Q{http://www.w3.org/2001/XMLSchema}boolean"
                    select="Q{urn:x-xspec:common:deep-equal}deep-equal($Q{urn:x-xspec:compile:impl}expect-d57e25, $Q{http://www.jenitennison.com/xslt/xspec}result, '')"/>
      <xsl:if test="not($Q{urn:x-xspec:compile:impl}successful)">
         <xsl:message>      FAILED</xsl:message>
      </xsl:if>
      <xsl:element name="test" namespace="http://www.jenitennison.com/xslt/xspec">
         ...
         <xsl:call-template name="Q{urn:x-xspec:common:report-sequence}report-sequence">
            <xsl:with-param name="sequence" select="$Q{urn:x-xspec:compile:impl}expect-d57e25"/>
            <xsl:with-param name="report-name" select="'expect'"/>
         </xsl:call-template>
      </xsl:element>
   </xsl:template>
