...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
   ...
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario1-expect1"
      ...
      <xsl:variable name="Q{urn:x-xspec:compile:impl}expect-d55e5-doc"
                    as="document-node()"
                    select="doc('file:/home/circleci/repo/src/test/resources/expected/transclusion.001.html')"/>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}expect-d55e5"
                    select="$Q{urn:x-xspec:compile:impl}expect-d55e5-doc ! ( . )"><!--expected result--></xsl:variable>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}successful"
                    as="Q{http://www.w3.org/2001/XMLSchema}boolean"
                    select="Q{urn:x-xspec:common:deep-equal}deep-equal($Q{urn:x-xspec:compile:impl}expect-d55e5, $Q{http://www.jenitennison.com/xslt/xspec}result, '')"/>
      ...
      <xsl:element name="test" namespace="http://www.jenitennison.com/xslt/xspec">
         ...
         <xsl:call-template name="Q{urn:x-xspec:common:report-sequence}report-sequence">
            <xsl:with-param name="sequence" select="$Q{urn:x-xspec:compile:impl}expect-d55e5"/>
   ...
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario2-expect1"
      ...
      <xsl:param name="Q{http://www.jenitennison.com/xslt/xspec}result"
                 ...
                 required="yes"/>
      <xsl:message>expect it to produce the right results</xsl:message>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}expect-d55e8-doc"
                    as="document-node()"
                    select="doc('file:/home/circleci/repo/src/test/resources/expected/transclusion.002.html')"/>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}expect-d55e8"
                    select="$Q{urn:x-xspec:compile:impl}expect-d55e8-doc ! ( . )"><!--expected result--></xsl:variable>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}successful"
                    as="Q{http://www.w3.org/2001/XMLSchema}boolean"
                    select="Q{urn:x-xspec:common:deep-equal}deep-equal($Q{urn:x-xspec:compile:impl}expect-d55e8, $Q{http://www.jenitennison.com/xslt/xspec}result, '')"/>
      <xsl:if test="not($Q{urn:x-xspec:compile:impl}successful)">
         <xsl:message>      FAILED</xsl:message>
      </xsl:if>
      <xsl:element name="test" namespace="http://www.jenitennison.com/xslt/xspec">
         ...
         <xsl:call-template name="Q{urn:x-xspec:common:report-sequence}report-sequence">
            <xsl:with-param name="sequence" select="$Q{urn:x-xspec:compile:impl}expect-d55e8"/>
            <xsl:with-param name="report-name" select="'expect'"/>
         </xsl:call-template>
      </xsl:element>
   </xsl:template>
   ...
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario3-expect1"
      ...
      <xsl:param name="Q{http://www.jenitennison.com/xslt/xspec}result"
                 ...
                 required="yes"/>
      <xsl:message>expect it to produce the right results</xsl:message>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}expect-d55e11-doc"
                    as="document-node()"
                    select="doc('file:/home/circleci/repo/src/test/resources/expected/transclusion.003.html')"/>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}expect-d55e11"
                    select="$Q{urn:x-xspec:compile:impl}expect-d55e11-doc ! ( . )"><!--expected result--></xsl:variable>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}successful"
                    as="Q{http://www.w3.org/2001/XMLSchema}boolean"
                    select="Q{urn:x-xspec:common:deep-equal}deep-equal($Q{urn:x-xspec:compile:impl}expect-d55e11, $Q{http://www.jenitennison.com/xslt/xspec}result, '')"/>
      <xsl:if test="not($Q{urn:x-xspec:compile:impl}successful)">
         <xsl:message>      FAILED</xsl:message>
      </xsl:if>
      <xsl:element name="test" namespace="http://www.jenitennison.com/xslt/xspec">
         ...
         <xsl:call-template name="Q{urn:x-xspec:common:report-sequence}report-sequence">
            <xsl:with-param name="sequence" select="$Q{urn:x-xspec:compile:impl}expect-d55e11"/>
            <xsl:with-param name="report-name" select="'expect'"/>
         </xsl:call-template>
      </xsl:element>
   </xsl:template>
   ...
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario4-expect1"
      ...
      <xsl:param name="Q{http://www.jenitennison.com/xslt/xspec}result"
                 ...
                 required="yes"/>
      <xsl:message>expect it to produce the right results</xsl:message>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}expect-d55e14-doc"
                    as="document-node()"
                    select="doc('file:/home/circleci/repo/src/test/resources/expected/transclusion.004.html')"/>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}expect-d55e14"
                    select="$Q{urn:x-xspec:compile:impl}expect-d55e14-doc ! ( . )"><!--expected result--></xsl:variable>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}successful"
                    as="Q{http://www.w3.org/2001/XMLSchema}boolean"
